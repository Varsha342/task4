...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        ...
        cout<< "Good Afternoon mam"<<endl;
        string phrase = "Good Afternoon mam";
        string command = "espeak \""+ phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening mam"<<endl;
        string phrase = "Good Evening mam";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(strcmp(password, "varsha")==0){
            cout<<"\n<==================================================================================================>\n\n";
            wishme();
            do{
                cout<<"\n<==================================================================================================>\n\n";
                cout<<endl<<"How can i help you mam...."<<endl<<endl;

                string phrase = "How can i help you mam";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"Good Bye mam, have a nice day!!!!"<<endl;
                    string phrase = "Good Bye mam, have a nice day";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
                    ...
                    cout<<"I'm a virtual assistant created by Varsha !!!"<<endl;
                    string phrase = "I am a virtual assistant created by Varsha";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    cout<<"I'm good mam, tell me how can i help you.."<<endl;
                    string phrase = "I'm good mam, tell me how can i help you";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    CreateProcess(TEXT("code"), NULL, NULL, NULL, FALSE, NULL, NULL, NULL, &startInfo, &processInfo);
                }
